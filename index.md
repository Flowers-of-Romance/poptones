...
<div class="header">
  <h1>人工無能のサイト</h1>
  <p>やあ、ネットの端っこにようこそ。ここには何もないよ。 <span class="lang-switch"><a href="/poptones/en/">English</a> <button class="hex-toggle">16</button> <button class="bin-toggle">2</button></span></p>
